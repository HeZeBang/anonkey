...
import { MiNoteAnonymousIdentity } from '@/models/NoteAnonymousIdentity.js';
...
export type NoteAnonymousIdentitiesRepository = Repository<MiNoteAnonymousIdentity> & MiRepository<MiNoteAnonymousIdentity>;
